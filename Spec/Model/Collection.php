...
class Spec_Model_Collection implements Spec_Model_Collection_Interface
{
	/**
	 * @var string
	 */
...
*/
	...
	{
		if (!$value instanceof Spec_Model_Interface)
		{
	...
	/**
	 *
	 * @param Spec_Model_Interface|Spec_Model_Collection $data
	 */
	public function append($data)
	{
		if ($data instanceof Spec_Model_Interface)
		{
			$this->_data[]= $data;
		}
		elseif ($data instanceof Spec_Model_Collection)
		{
	 ...
	 * @return Spec_Model_Collection
	 */
	public function append_collection_by_key_name(Spec_Model_Collection $collection, $key_name = 'id')
	{
		$data = array();
	...
	{
		/* @var $relation Spec_Model_Relation */

...
abstract class Spec_Model_Relation implements Spec_Model_Relation_Interface
{
	/**
	 *
	 */
	 ...
	 * @param Spec_Model_Reflection_Property $property
	 *
	 * @return Spec_Model_Relation_Interface
	 */
	public final static function factory(Spec_Model_Interface $model, Spec_Model_Reflection_Property $property)
	{
	 ...
	 * @return string
	 */
	protected static function _get_relation_class_name(Spec_Model_Reflection_Property $property)
	{
		return "Spec_Model_Relation_{$property->params['relation']}";
	}
	 ...
	 * @param string $class
	 *
	 * @return Spec_Model_Mapper_Interface
	 */

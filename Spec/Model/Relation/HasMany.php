...
class Spec_Model_Relation_HasMany extends Spec_Model_Relation
{
	/**
	 * 
	 * @var string
	...
	public function get_foreign_object()
	{
		if (null === $this->_foreign_objects) 
		{
			...
			{
				$this->_foreign_objects = new Spec_Model_Collection;
			}
		}
	...
	/**
	 * 
	 * @param Spec_Model_Collection $objects
	 */

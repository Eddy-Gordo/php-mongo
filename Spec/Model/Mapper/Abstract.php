...
abstract class Spec_Model_Mapper_Abstract implements Spec_Model_Mapper_Interface
{
	/**
	 * Model class implementing Spec_Model_Interface
	 * @var string
	 */
	 ...
	 * @var string
	 */
	protected $_model_collection_class_name = 'Spec_Model_Collection';
	 ...
	 *
	 * @param mixed $data
	 * @return Spec_Model_Collection_Abstract
	 */
	public function create_model_collection($data)
	{
		...
		{
			if (!$model instanceof Spec_Model_Interface)
			{
	 ...
	 *
	 * @return Spec_Model_Mapper_Abstract
	 */

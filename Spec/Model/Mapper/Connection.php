...
class Spec_Model_Mapper_Connection
{
	...
	{
		$this->_name = $name;
		$this->_config = $this->_getConfig($name);
	}
	...
	public function connect ()
	{
		...
		$this->_connection = new Mongo($host, $options);
		...
		{
			throw new Zend_Exception('Unable to connect to Mongo server at :hostnames',
				array(':hostnames' => $e->getMessage()));
		}

		if ( ! isset($this->_config['connection']['db']))
		{
			throw new Zend_Exception('No database specified in MangoDB Config');
		}

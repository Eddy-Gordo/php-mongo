...
class Spec_Paginator_Adapter_Mapper implements Zend_Paginator_Adapter_Interface
{
	/**
	 * @var Spec_Model_Mapper_Interface|null
	 */
	 ...
	 * @param array $sort
	 */
	public function __construct (Spec_Model_Mapper_Interface $mapper, array $cond = null, array $sort = null)
	{
		$this->_mapper = $mapper;
		$this->_cond = $cond;
		$this->_sort = $sort;
	 ...
	 * @param int $offset
	 * @param int $limit
	 * @return array|Spec_Model_Collection
	 */
	public function getItems ($offset, $limit)
	{
		...
		{
			return $this->_dataMapper['instance']->execute($data, $this->_dataMapper['context'], $this->_dataMapper['initialData']);
		}
	...
	public function setDataMapper(array $mapper)
	{
		...
		{
			throw new App_Exception_System('Mapper should be specified');
		}
